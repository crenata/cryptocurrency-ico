...
contract DappTokenCrowdsale is Crowdsale, MintedCrowdsale, CappedCrowdsale, TimedCrowdsale, WhitelistedCrowdsale, RefundableCrowdsale {
    ...
    uint256 public investorMinCap = 2000000000000000; // wei // 0.002 Ether
    uint256 public investorHardCap = 50000000000000000000; // wei // 50 Ether
    mapping(address => uint256) public contributions;

    // Crowdsale Stages
    enum CrowdsaleStage {PreICO, ICO}
    // Default to Pre-sale stage
    ...
    /*
     * @dev Forwards funds to the wallet during the pre-ICO stage, then the refund vault during ICO stage.
     */
     ...
     * @param _weiAmount Amout of wei contributed.
     */
    ...
    /*
     * @dev Enable token transfers, called when owner calls finalization().
     */
